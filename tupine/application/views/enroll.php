    ...
    <section>
        <nav class="navbar navbar-light" style="background-color: #EEEEEE;">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="<?php echo base_url("assets/logo-tupine.png") ?>"
                        height="120" alt="tupine logo" loading="lazy" /></a>

                <div class="btn-group me-md-5" role="group">
                    <button class="btn  btn-danger me-md-5 dropdown-toggle " id="dropdownMenuButton1"
                        data-bs-toggle="dropdown" aria-expanded="false" style="width:150px;" type="button"><b>
    ...
    <div class="container">
        ...
        <section>
            <div class="col-12 pt-3" style="border-bottom: 6px solid #BB0000;">
                <button class="btn btn-primary me-md-2 fs-5 " type="button"
                    style="background-color:#BB0000; color: #FFFFFF; border:none; width:100px;">Profile</button>
            </div>
        </section>
                    ...
                    <div class="card">
                        ...
                        <div class="container mt-4 mb-4">
                            ...
                            <div class="card-body mt-3" style="background-color: #EEEEEE; border-radius: 5px;">
                                ...
                                <section>
                                    <b>1.High school CGPA <br>(Minimum 3.00 CGPA required for admission based on at
                                        least 6 semesters of high school)</b>
                                    <div class="row g-3 align-items-center mt-1">
                                        <div class="col-auto">
                                            <label for="cgpa" class="col-form-label">CGPA:</label>
                                        </div>
                                        <div class="col-auto">
                                            <input name="CGPA" type="text" id="cgpa" class="form-control"
                                                placeholder="CGPA">
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <label for="engscore_type">2.English score (Choose only one type)*</label>
                                    <div class="mt-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="engscore_type"
                                                id="tuget_p" value="TU-GET(PBT)" onclick="showContent()">
                                            <label class="form-check-label">TU-GET (PBT)</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="engscore_type"
                                                id="tuget_c" value="TU-GET(CBT)" onclick="showContent()">
                                            <label class="form-check-label">TU-GET (CBT)</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="engscore_type"
                                                id="toefl_p" value="TOEFL(PBT)" onclick="showContent()">
                                            <label class="form-check-label">TOEFL (PBT)</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="engscore_type"
                                                id="toefl_i" value="TOEFL(IBT)" onclick="showContent()">
                                            <label class="form-check-label">TOEFL (IBT)</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="engscore_type" id="ielts"
                                                value="IELTS" onclick="showContent()">
                                    ...
                                    <div id="TU-GET(PBT)" class="row mt-3 collapse">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" name="engscore" id="tugetInputP" class="form-control"
                                                placeholder="TU-GET (PBT)">
                                        </div>
                                    ...
                                    <div id="TU-GET(CBT)" class="row mt-3 collapse">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" name="engscore" id="tugetInputC" class="form-control"
                                                placeholder="TU-GET (CBT)">
                                        </div>
                                    ...
                                    <div id="TOEFL(PBT)" class="row mt-3 collapse">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" name="engscore" id="toeflInputP" class="form-control"
                                                placeholder="TOEFL (PBT)">
                                        </div>
                                    ...
                                    <div id="TOEFL(IBT)" class="row mt-3 collapse">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" name="engscore" id="toeflInputI" class="form-control"
                                                placeholder="TOEFL (IBT)">
                                        </div>
                                    ...
                                    <div id="IELTS" class="row collapse mt-3">
                                        ...
                                        <div class="col-auto">
                                            <input type="text" name="engscore" id="ieltsInput" class="form-control"
                                                placeholder="IELTS">
                                        </div>
                                ...
                                <section>
                                    <div class="mt-3">
                                        <lable for="resulttest">3.Upload english test score.*</lable>
                                    </div>
                                    <div class="mt-3">
                                ...
                                <section>
                                    ...
                                    <div class="mt-3">
                                        <label for="copyidcard" class="form-label" style="font-size: 13px;">-A copy of
                                            Thai national ID
                                            card or a copy Passport.</label>
                                        <input class="form-control form-control-sm" id="copyidcard" type="file">
                                    </div>
                                    <div class="mt-3">
                                        <label for="photocolor" class="form-label" style="font-size: 13px;">-A 1-inch
                                            color photograph,
                                            taken in last 6 months; Use a clear image of your face:Straigh face and do
                                            not wear a hat or glasses.</label>
                                        <input class="form-control form-control-sm" id="photocolor" type="file">
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label for="transcipt" class="form-label" style="font-size: 13px;">-High school
                                            transcript(if
                                            you have other educational document, please combine into a single file to
                                            upload.)</label>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-center mx-auto">
                                <button class="btn  btn-danger mt-5" id="submit" type="submit"
